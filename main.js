    ...
    const template = [{
        ...
        },
        {
            ...
            submenu: [{
                ...
                },
                {
                    label: "Docs",
                    click: function () {
                        electron.shell.openExternal('https://github.com/David-Honisch/LC2Youtube2mp3/README.md');
                    }
                },
                {
                    type: "separator"
        ...
        },
        {
            ...
            submenu: [{
                    label: "Disclaimer",
                    click: function () {
                        electron.shell.openExternal('https://github.com/David-Honisch/LC2Youtube2mp3#disclaimer');
                    }
                }]
        },
    ];
